...
\subsection{Ambiente de Teste}
    ...
    Especialmente na verão com OpenMP, como não foi específicado o número de threads, o código utilizou o número de núcleos lógiocs disponíveis pelo processador, que nesse ambiente de testes, foram 16.
